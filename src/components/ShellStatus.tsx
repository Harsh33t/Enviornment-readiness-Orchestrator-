...
export const ShellStatus: React.FC = () => {
  const boundaries = [
    { label: 'Network Isolation', value: 'Local In-Memory Mock Endpoints Only', status: 'pass' },
    { label: 'Credentials & Auth', value: 'Synthetic Tokens (Zero Real Secrets Stored)', status: 'pass' },
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px', flexWrap: 'wrap', gap: '12px' }}>
        <div>
          <span className="badge badge-pass" style={{ marginBottom: '8px' }}>
            ✓ Portfolio Prototype Active
          </span>
          <h2 style={{ fontSize: '1.25rem', marginTop: '4px' }}>Prototype Safety & Boundary Verification</h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem' }}>
            This standalone prototype demonstrates E2E preflight checks and setup classification safely using isolated mock engines.
          </p>
        </div>
        <div style={{ display: 'flex', gap: '8px' }}>
          <a
            href="https://github.com/Harsh33t/Enviornment-readiness-Orchestrator-"
            target="_blank"
            rel="noreferrer"
